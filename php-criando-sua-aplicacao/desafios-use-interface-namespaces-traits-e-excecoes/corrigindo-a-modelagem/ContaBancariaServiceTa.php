...
class ContaBancariaServiceTa
{
        ...
        public function depositar(ContaBancariaTa $conta, float $valor): string
        {
            if ($conta->depositar($valor)) {
                return "Depósito na conta do cliente: " . $conta->cliente->nome . ", realizada com sucesso!";
            } else {
                return "Depósito na conta do cliente: " . $conta->cliente->nome . ", não foi realizada, verificar se conta está ativa ou valor para depósito é maior do que zero.";
            }
        }
        ...
        public function sacar(ContaBancariaTa $conta, float $valor): string
        {
            if ($conta->sacar($valor)) {
                return "Saque na conta do cliente: " . $conta->cliente->nome . ", realizada com sucesso!";
            } else {
                return "Saque na conta do cliente: " . $conta->cliente->nome . ", não foi realizada, verificar se conta está ativa ou digitou um valor válido (respeitando limite de saque e taxa de manutenção).";
            }
        }
        ...
        public function desativar(ContaBancariaTa $conta): string 
        {
            if ($conta->desativar()) {
                ...
                return "Conta do cliente: " . $conta->cliente->nome . ", não foi desativada, por favor verificar se conta já não se encontra desativada ou saldo ainda é diferente de 0.";
            }
        }
        ...
        {
            if ($conta->estaAtiva()) {
                return "Conta está ativa.";
            } else {
                return "Conta está desativada.";
            }
        }
}
